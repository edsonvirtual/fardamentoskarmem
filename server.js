...
// Caso contrário, usa as credenciais locais.
const isProduction = process.env.DATABASE_URL ? true : false;

const pool = new Pool({
    connectionString: process.env.DATABASE_URL || 'postgres://postgres:1234L@localhost:5432/karmem_db',
    ssl: isProduction ? { rejectUnauthorized: false } : false // SSL obrigatório para Neon/AWS
});

// --- ROTA DE ESTORNO (TRANSAÇÃO SQL) ---
...
app.listen(PORT, () => console.log(`Servidor Karmem rodando na porta ${PORT}`));